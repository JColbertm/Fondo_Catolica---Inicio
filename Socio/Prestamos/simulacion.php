<div class="row">
  <div class="card">
    <div class="card-action">
      <a>Simulaci&oacute;n Pr&eacute;stamo</a>
    </div>
        ...
        <form class="col s12 offset-m1 m10">
          <div class="row">
            <div class="input-field col s12">
              <input id="montosimu" type="text" class="validate">
              <label><i class="fa fa-usd" aria-hidden="true"></i> Monto:</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s12">
              <input id="cantmeses" type="text" class="validate">
              <label><i class="fa fa-calendar" aria-hidden="true"></i> Meses Plazo:</label>
            </div>
          </div>
          <div class="row">
            <div class="col offset-m8 m4">
              <a class="waves-effect waves-light modal-trigger btn" href="#modalsimu"><h6><i class="fa fa-gamepad" aria-hidden="true"></i> Simular</h6></a>
            </div>                  
          </div>               
        </form>
      </div> 
    ...
    <div class="modal-content">
      <div class="row">
        <div class="col offset-m1 m10">
          <h4>Simulaci&oacute;n Pr&eacute;stamo</h4>
          <form>                
                <div class="row">
                  <div class="input-field col s12">
