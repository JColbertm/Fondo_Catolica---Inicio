			...
			<form class="col s12 m12">
				...
				<div class="row">				
                 ...
                 <div class="row">
					<div align="center">
						...
						<h4>AUTORIZACIÓN PARA INCREMENTO DE APORTES</h4>
					</div>
				</div>
				<br>
				<div class="row">
				...
				<div class="row">
						<div class="col s7 l8">
							...
							<br>
							<p>Solicito <b>incrementar</b> mi aporte, a partir del mes de:</p>
						</div>
				...
				<div class="row">
						<div class="col s7 l5">
						<br><br>
							<p>a partir de ese mes será de Bs </p>
						</div>
				...
				<div class="row">
					<div class="col s12 l12">
						<br>
						<p>El Fondo de Ahorro y Crédito “San Pablo”, autoriza el incremento a partir de la fecha: </p>
					</div>
				...
				<br><br><br>
					<div class="center">
						<h6>-----------------------------------</h6>
						<h6>Pdte. Comité Administrativo</h6>
					</div>
