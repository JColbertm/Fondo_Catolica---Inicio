      ...
      <!-- con css hacemos que los botones sean estaticos -->
        ...
        <div id="modal3" class="modal" style="display: none; opacity: 1; top: 0px;">
                ...
                <div class="modal-content center">
                    <h4>Simulacion</h4>
                        <div class="row">
                        <div class=" col offset-m3 m2 offset-l3 l2"><br> Monto:</div>
                        <div class="col m3 l3">
                        <input type="text" id="simu_pres_monto">
                        </div>
                        </div>
                        <div class="row">
                        <div class=" col offset-m2 m3 offset-l3 l2"><br> Mes Plazo:</div>
                        <div class="col m3 l3">
                        <input type="text" id="simu_pres_mes">
